...
import octiconKey from "../../public/assets/img/svg/octicon-key.svg";
...
import octionServer from "../../public/assets/img/svg/octicon-server.svg";
...
export function svgParseOuterInner(name) {
  ...
  const p1 = svgStr.indexOf(">"),
    p2 = svgStr.lastIndexOf("<");
